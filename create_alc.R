...
# Read the data file
mat <- read.table("/IODS-project/studentmat.csv", sep = ";", header = T)
por <- read.table("/IODS-project/studentpor.csv", sep = ";", header = T)
...
# 370 observations of 35 variables
>>>>>>> 49f2d84ef615419c3a9d10e5e8a33211afa7772f
